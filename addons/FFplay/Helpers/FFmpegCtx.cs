...
namespace FFmpeg.Godot.Helpers
{
    public sealed unsafe class FFmpegCtx : IDisposable
    {
        ...
        public bool TryGetPts(out double fps)
        {
            ...
            fps = _pFormatContext->streams[_streamIndex]->time_base.den / ((double)_pFormatContext->streams[_streamIndex]->avg_frame_rate.num / _pFormatContext->streams[_streamIndex]->avg_frame_rate.den);
